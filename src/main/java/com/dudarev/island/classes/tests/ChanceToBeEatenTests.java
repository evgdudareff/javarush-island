...
public class ChanceToBeEatenTests {
    ...
    public void checkThatWolfHasVictims() throws Exception {
        ...
        if (wolfsVictimsClassNames.size() == 0) {
            throw new Exception("checkThatWolfHasVictims should have victims");
        }

        System.out.println("Wolf have victims:" + wolfsVictimsClassNames);

        System.out.println("checkThatWolfHasVictims ends");
        System.out.println("-----------------------------------------");
    }
