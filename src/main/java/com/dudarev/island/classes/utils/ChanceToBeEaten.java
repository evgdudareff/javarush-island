...
public class ChanceToBeEaten {
    private static final HashMap<String, HashMap<String, Integer>> chanceToBeEatenMap = new HashMap<>(){{
    ...
    public static boolean isAttackerEatsVictim(Animal attacker, SimulationItem victim) {
